...
export class PostController {
  createPost = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      res
        ...
        .json(
          new ApiResponse(STATUS_CODE.CREATED, post, "Post Creation Success")
        );
    }
  );
  ...
  submitPost = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      const result = await postServices.submitForApproval(
        postId,
        req.user.userId
      );
  ...
  approvePost = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      res
        .status(STATUS_CODE.SUCCESS)
        .json(new ApiResponse(STATUS_CODE.SUCCESS, result, "Post approved"));
    }
  );
  ...
  rejectPost = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      const result = await postServices.rejectPost(
        postId,
        req.user.userId,
        reason
      );
      ...
      res
        ...
        .json(
          new ApiResponse(
            STATUS_CODE.SUCCESS,
            post,
            "Pending Posts of the group served"
          )
        );
    }
  );
  ...
  getUserPosts = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      res
        .status(STATUS_CODE.SUCCESS)
        .json(
          new ApiResponse(STATUS_CODE.SUCCESS, userPosts, "User posts served")
        );
    }
  );
  ...
  uploadMedia = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      const addedMedia = await postServices.addMediaToPost(
        postId,
        req.user?.userId,
        mediaUrls
      );
  ...
  removeMedia = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      const result = await postServices.removeMediaFromPost(
        postId,
        mediaId,
        userId
      );
