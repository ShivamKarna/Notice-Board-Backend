...
export class GuestController {
  getPublicGroups = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      if (req.sessionToken) {
        await guestService.trackGuestActivity(
          req.sessionToken,
          "view_public_groups"
        );
      }
      ...
      res
        ...
        .json(
          new ApiResponse(STATUS_CODE.SUCCESS, result, "Public groups served")
        );
    }
  );
  getGroupDetails = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      res
        .status(STATUS_CODE.SUCCESS)
        .json(
          new ApiResponse(STATUS_CODE.SUCCESS, group, "Group details served")
        );
    }
  );
  getGroupPublicPosts = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      AppAssert(groupId, STATUS_CODE.NOT_FOUND, "Group id not given in params");
      const result = await guestService.getGroupPublicPosts(
        groupId,
        page,
        limit
      );
  ...
  getPublicPost = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      res
        .status(STATUS_CODE.SUCCESS)
        .json(new ApiResponse(STATUS_CODE.SUCCESS, post, "Post served"));
    }
  );
  getPublicFeed = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      res
        .status(STATUS_CODE.SUCCESS)
        .json(
          new ApiResponse(STATUS_CODE.SUCCESS, result, "Public Feed served")
        );
    }
  );
  getTrendingGroups = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      res
        .status(STATUS_CODE.SUCCESS)
        .json(
          new ApiResponse(STATUS_CODE.SUCCESS, groups, "Trending Groups Served")
        );
    }
  );
  getTrendingPosts = AsyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      res
        .status(STATUS_CODE.SUCCESS)
        .json(
          new ApiResponse(STATUS_CODE.SUCCESS, posts, "Trending Posts Served")
        );
    }
  );
